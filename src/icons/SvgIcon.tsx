...
const checkedListIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
                             data-icon="tasks" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                             data-fa-i2svg="">
...
const orderedListIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
                             data-icon="list-ol" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                             data-fa-i2svg="">
    <path fill="currentColor"
...
const unorderedListIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
...
const imageIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
...
const codeIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas" data-icon="code"
...
const quoteIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
                       data-icon="quote-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                       data-fa-i2svg="">
    <path fill="currentColor"
...
const linkIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas" data-icon="link"
...
const strikeThroughIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
...
const italicIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
                        data-icon="italic" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                        data-fa-i2svg="">
    <path fill="currentColor"
          d="M204.758 416h-33.849l62.092-320h40.725a16 16 0 0 0 15.704-12.937l6.242-32C297.599 41.184 290.034 32 279.968 32H120.235a16 16 0 0 0-15.704 12.937l-6.242 32C96.362 86.816 103.927 96 113.993 96h33.846l-62.09 320H46.278a16 16 0 0 0-15.704 12.935l-6.245 32C22.402 470.815 29.967 480 40.034 480h158.479a16 16 0 0 0 15.704-12.935l6.245-32c1.927-9.88-5.638-19.065-15.704-19.065z"/>
</svg>;

const headerIcon = <svg className="svg-icon" aria-hidden="true" data-prefix="fas"
                               data-icon="heading" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                               data-fa-i2svg="">
    <path fill="currentColor"
...
const boldIcon =
    <svg className="svg-icon" aria-hidden="true" data-prefix="fas" data-icon="bold" role="img"
